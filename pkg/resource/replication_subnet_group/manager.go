...
// +kubebuilder:rbac:groups=dms.services.k8s.aws,resources=replicationsubnetgroups,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=dms.services.k8s.aws,resources=replicationsubnetgroups/status,verbs=get;update;patch
